...
export const TASK_QUESTIONS = {
  ...
  stakes: {
    type: 'noul',
    instructions:
      'Would a subtle mistake here be costly, dangerous, or hard to reverse (security, data loss, production systems, money, correctness-critical logic)?',
  },
...
export const STEP_QUESTIONS = {
  ...
  stuck: {
    type: 'noul',
    instructions:
      'Is the agent stuck: repeating a failed approach, going in circles, or making no progress over its recent steps?',
  },
} satisfies Record<string, JevQuestion>;
